...
const BentoGrid = ({
  ...
  return (
    <div
      className={cn(
        "grid w-full auto-rows-[18em] grid-cols-3 gap-1",
        className,
      )}
    >
      {children}
...
const BentoCard = ({
    ...
    <div
      ...
      className={cn(
        ...
        // light styles
        "bg-neutral [box-shadow:0_0_0_1px_rgba(0,0,0,.03),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)]",
        // dark styles
    ...
    <div
      className={cn(
        "pointer-events-none absolute bottom-0 flex w-full translate-y-full transform-gpu flex-row items-center p-4 opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100",
      )}
    >
